 ...
 * @new_entry: new_item entry to be added
 ...
 * @new_entry : the new_item element to insert
 *
 ...
 * @list: a new_item list to add all removed entries
...
static inline void hlist_move_list(struct hlist_head *old,
				   struct hlist_head *new_item)
{
	new_item->first = old->first;
	if (new_item->first)
		new_item->first->pprev = &new_item->first;
	old->first = NULL;
}
